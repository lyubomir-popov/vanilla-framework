...
const Nav = () => (
  <header id="navigation" className="p-navigation row">
    <div className="p-navigation__banner">
      <div className="p-navigation__logo u-no-margin--left">
        <a className="p-navigation__link" href="#a">
          <img className="p-navigation__image" src="https://assets.ubuntu.com/v1/d96d86b5-vanilla_black-orange_hex.svg" alt="" width="95" />
        </a>
      </div>
    ...
    <nav className="p-navigation__nav">
      <form className="p-search-box" action="/search">
        <input type="search" className="p-search-box__input" name="q" placeholder="Search" required="" />
